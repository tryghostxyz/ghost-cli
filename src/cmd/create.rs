...
pub struct CreateCmd {
    ...
    #[arg(
        long,
        short,
        help = "Specify the chain. Options: eth-mainnet, eth-sepolia, base-mainnet, base-sepolia, bera-testnet, berachain, blast-mainnet, abstract-testnet, abstract, uni-testnet, unichain or chain id"
    )]
    pub chain: Chain,
